...
(function() {
  ...
  function ngHtmlDragDrop($parse, $timeout, $log, $window, DragDropService) {
    ...
    function link(scope, element, attrs, ngModel) {
      ...
      dataModel._options.inUse = false;
      dataModel._options.isHandle = false;

      DragDropService.setColumns(element);

      var _onHandleDrop = DragDropService.handleDrop.bind(this, ngModel, dataModel, scope, sortable);
      ...
      sortable.handleDragStart = function(e) {
        ...
        dataModel._sourceItem = null;
        //$window['drag_source_extra'] = null;

        if (sortable.options && !dataModel._options.isHandle && sortable.options.handle) {
          e.preventDefault();
          return;
        }
      ...
      sortable.unbind = function() {
        ...
        [].forEach.call(sortable.cols_, function(col) {
          ...
          col.removeEventListener('drop', _onHandleDrop, false);
          col.removeEventListener('dragend', DragDropService.handleDragEnd, false);
        });
        dataModel._options.isHandle  = false;
      }
      ...
      sortable.activehandle = function($event) {
        ...
        dataModel._options.isHandle = true;
      }

      sortable.register_drop = function(element_children) {
        element_children.addEventListener('drop', _onHandleDrop, false);
        ...
        element_children.addEventListener('dragend', DragDropService.handleDragEnd, false);
      }
      ...
      if (ngModel) {
        ngModel.$render = DragDropService.onModelRender.bind(this,
          scope,
          element,
          attrs,
          ngModel,
